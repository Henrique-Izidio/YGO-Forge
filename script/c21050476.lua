...
function s.initial_effect(c)
    ...
    e5:SetHintTiming(0, TIMING_STANDBY_PHASE+TIMING_END_PHASE)
...
function s.plcon1(e,tp,eg,ep,ev,re,r,rp,chk)
    return not Duel.IsPlayerAffectedByEffect(tp, AMPHI)
end

function s.plcon2(e,tp,eg,ep,ev,re,r,rp,chk)
    return Duel.IsPlayerAffectedByEffect(tp, AMPHI)
end
